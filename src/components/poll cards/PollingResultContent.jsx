    ...
    return (
        <div className="">
            <div className="w-full bg-gray-800 flex items-center gap-2 mb-4 rounded-md overflow-hidden">
                <img src={imgUrl} alt="image-poll-option" className="w-full h-36 object-contain" />
            </div>
    ...
    return (
        <div className="mb-8 ml-3">
            <div className="flex gap-3">
                {
                    profileImgUrl ? (
                        <img src={profileImgUrl} alt="profile-img" className="w-8 h-8 rounded-full" />
                    ) : (
                        <CharAvatar
...
export const PollingResultContent = ({
    type,
    options,
    voters,
    responses
            ...
            return responses.map((response) => {
                return (
                    <OpenEndedPollResponse
                        ...
                        userFullName={response.voterId?.fullName || "Trung Nam"}
